...
print(f"There is a {object1}, a {object2}, and my {object3} infront of me ")
...
# Experiment with the sep and end parameters of the print() function to produce different outputs.
